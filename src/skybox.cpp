...
Skybox::Skybox(Game& game, std::vector<std::string> textures, float size): game(game), size(size) {
    VAO = initRenderData();
...
unsigned int Skybox::initRenderData() {
    ...
    ResourceManager::LoadShader("shaders/Skybox.vert", "shaders/Skybox.frag", nullptr, "Skybox").Use();
    unsigned int newVAO;
